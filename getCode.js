...
//getCode function returns the contract byte code of the given contract address. 
//getCode can also accept a blockTag. If there is no contract deployed at that block, it returns "0x"

const getCode = async (contract) => {
